 ...
 */
export async function login(session: Session, endpoint: string, username: string, password: string): string {
    try {
 ...
 * @return {string}
 */
export async function handleFailedResponse(response: FetchResponse): string {
